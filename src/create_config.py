...
data['stt_engine'].append({
    'name': 'stt_viettel',
    'token': 'SythBY7N8AUn5345dgdfg654646hfghgfhRNwYE8N',
    'token_file': '',    
    'time_out': 4000,
    'is_active': False    
})
...
data['tts_engine'].append({
    'token': 'AIza45gdfgfdg5654ghf7-smS6hPxhw6_k16b3c',
    'token_file': 'google.json',    
    'name': 'tts_gg_cloud',    
...
data['tts_engine'].append({
    'token': 'SythBY743543gdfgdfgdsfdsfAebU7twsjBFqq-jxLrWpxlyXxzdWRNwYE8N',
    'token_file': '',    
    'name': 'tts_viettel',    
...
data['tts_engine'].append({
    'token': '8sJJ39ofsdfsdfsdfBXC2fRGU',
    'token_file': '',    
    'name': 'tts_zalo',
    'voice_name': '1',    
    'speed': 1.0,
...
data['hass_skill'].append({
    ...
    'long_token': 'eyJ0eXAiOiJKV1QiL5345dgdgdfgWZiNTkzMSIsImlhdCI6MTYxNjA3MjcwNywiZXhwIjoxOTMxNDMyNzA3fQ.QSNK0ptkagGwVCL-Nd092E7FQYLNXjeVJstqnl5Ub14',
    'is_active': False        
})
