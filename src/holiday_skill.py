...
def xuly(data):
    ...
    if request_holiday_name[0] in data:
        xx = yy + 1
        ...
        nm = str(ev.year)
        d = ev - ngay
        a = request_holiday_name[0]        
    elif request_holiday_name[1] in data:
        xx = yy + 1
        ev = datetime.datetime(xx,1,1)
        n = str(ev.day)
        t = str(ev.month)
        nm = str(ev.year)
        d = ev - ngay
        a = request_holiday_name[1]        
    elif request_holiday_name[2] in data:
        nam_a = nam_am + 1
        ...
        d = a2d - ngay
        a = request_holiday_name[2]               
    elif request_holiday_name[3] in data:
        nam_a = nam_am + 1
        a2d = L2S(28,12,yy,nam_nhuan) #Đổi sag nggayf dương 28/12
        nd = a2d[0]
        td = a2d[1]
        ...
        a2d = datetime.datetime.strptime(daa, '%d-%m-%Y')
        d = a2d - ngay
        a = request_holiday_name[3]         
    elif request_holiday_name[4] in data:
        ...
        a2d = datetime.datetime.strptime(daa, '%d-%m-%Y')
        d = a2d - ngay
        request_holiday_name[4]        
    elif request_holiday_name[5] in data :
        ev = L2S(10,3,nam_am,nam_nhuan)
        n = str(ev[0])
        t = str(ev[1])
        nm = str(ev[2])
        ...
        a2d = datetime.datetime.strptime(daa, '%d-%m-%Y')
        d = a2d - ngay
        request_holiday_name[5]     
    elif request_holiday_name[6] in data:
        ev = datetime.datetime(yy,4,30)
        n = str(ev.day)
        t = str(ev.month)
        nm = str(ev.year)
        d = ev - ngay
        a = request_holiday_name[6]
    elif request_holiday_name[7] in data :
        ev = datetime.datetime(yy,1,5)
        n = str(ev.day)
        t = str(ev.month)
        nm = str(ev.year)
        d = ev - ngay
        a = request_holiday_name[7]        
    elif request_holiday_name[8] in data :
        ev = datetime.datetime(yy,1,5)
        n = str(ev.day)
        t = str(ev.month)
        nm = str(ev.year)
        d = ev - ngay
        a = request_holiday_name[8]       
    elif request_holiday_name[9] in data :
        ev = datetime.datetime(yy,9,2)
        n = str(ev.day)
        t = str(ev.month)
        nm = str(ev.year)
        d = ev - ngay
        a = request_holiday_name[9]
    elif request_holiday_name[10] in data:
        ev = datetime.datetime(yy,9,2)
        n = str(ev.day)
        t = str(ev.month)
        nm = str(ev.year)
        d = ev - ngay
        a = request_holiday_name[10]
    elif request_holiday_name[11] in data:
        ev = datetime.datetime(yy,9,2)
        n = str(ev.day)
        t = str(ev.month)
        nm = str(ev.year)
        d = ev - ngay
        a = request_holiday_name[11]
    elif request_holiday_name[12]in data:
        ...
        a2d = datetime.datetime.strptime(daa, '%d-%m-%Y')
        d = a2d - ngay
        a = request_holiday_name[12]    
    elif request_holiday_name[13] in data :
        ev = L2S(15,8,nam_am,nam_nhuan)
        n = str(ev[0])
        t = str(ev[1])
        nm = str(ev[2])
