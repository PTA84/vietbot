...
def listen_print_loop(responses):
    ...
    for response in responses:           
        ...
        if not result.is_final:
            sys.stdout.write('[HUMAN]: '+ transcript + overwrite_chars + '\r')
            sys.stdout.flush()
            ...
            # if any(item in transcript.lower() for item in keywords) == True:    
                ...
                # return data
                # break
            # elif any(item in transcript.lower() for item in stopwords) == True:
                # return data
                # break
            return data            
            break
...
def main():
    ...
    config = speech.RecognitionConfig(encoding=speech.RecognitionConfig.AudioEncoding.LINEAR16,sample_rate_hertz=RATE,language_code=language_code, model='command_and_search', metadata =metadata)
