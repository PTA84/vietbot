...
data['tts_engine'].append({
    'token': 'AIzaSyDsfdlsfljsjlfd-sdfsfdjlsf_k16b3c',
    'token_file': 'google.json',    
    'name': 'tts_gg_cloud',    
...
data['tts_engine'].append({
    'token': 'SythBY7fjslfjlsajflljdsfjldsaNwYE8N',
    'token_file': '',    
    'name': 'tts_viettel',    
...
data['tts_engine'].append({
    'token': '8sJJ39osdfljsfjlasljdfBXC2fRGU',
    'token_file': '',    
    'name': 'tts_zalo',
    'voice_name': '1',    
    'speed': 1.0,
...
data['tts_engine'].append({
    'token': '7591A4mlsfjlsfljadsljfNkyEqEC',
    'name': 'tts_fpt',
    'voice_name': 'linhsan',
    'speed': 1.0,
    'pitch': '',    
...
data['spotify_skill'].append({
    'client_id': '8fcfa835ba204503548oejtoeb62a9d0260',
    'client_secret': '5b1ae3497203504385eotuoet0efe1b195',
    'redirect_url': 'http://localhost:3979',
    'device_id': '2244d6ab3354803eoletb22ac71571c',
    'is_active': False        
})
data['mqtt_skill'] = []
